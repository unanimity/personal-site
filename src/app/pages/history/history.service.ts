...
export class HistoryService {
 public  Text = 'I was born on September 27, 1995 in the Donetsk city, Ukraine. My father has engineering education, works as a car mechanic. Mother engineer technologist.\n' +
    ...
    '  On August 12, 2014, in connection with the anti-terrorist operation in the Donetsk region, I moved to Kursk, Russia.\n' +
    ...
    '   In July 2019, I received a master\'s degree in computer science and moved to Quito, Ecuador. I work as an teacher-researcher at the center of robotics at the Central University of Ecuador';
  constructor() { }
}
